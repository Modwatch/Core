...
/** @typedef {import("@modwatch/types").ModFile} ModFile */
/** @typedef {import("@modwatch/types").FileName} FileName */
/** @typedef {import("@modwatch/types").Game} Game */
/** @typedef {import("../types").JWT} JWT */

/** @type {Partial<Modlist>} */
...
/** @type {Partial<Modlist>[]} */
export const users = [
  { username: "Peanut", timestamp: new Date("1995-12-17T03:24:00"), game: "skyrim" },
  { username: "Sunconure11", timestamp: new Date("1995-12-17T03:23:54"), game: "skyrimse" },
  { username: "eeekief", timestamp: new Date("1995-12-17T03:23:20"), game: "fallout4" },
